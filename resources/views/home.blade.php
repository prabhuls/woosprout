...
<body class="bg-gradient-to-b from-stone-100 min-h-screen antialiased">
    <div class="container mx-auto">
        ...
        <div class="my-4 lg:my-24 flex flex-col justify-center text-center p-4" style="min-height:85vh">
            ...
            <div class="mx-auto my-2 text-sm text-accent">You need an invite code to create an account.</div>
        </div>
        ...
        <div class=" p-4 lg:p-8 bg-stone-50">
            <footer class="footer items-center container mx-auto">
                <div class="items-center grid-flow-col text-center md:text-left">
